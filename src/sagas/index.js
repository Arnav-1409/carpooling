...
import ldapSignupSaga from './ldapSignupSaga';
import ldapLoginSaga from './ldapLoginSaga';
import yourBookingsSaga from './yourBookingsSaga';
import yourOfferedRidesSaga from './yourOfferedRidesSaga';
import ldapEnabledSaga from './ldapEnabledSaga';
...
export default function* rootSaga() {
  yield all([
    ...
    fork(ldapSignupSaga),
    fork(ldapLoginSaga),
    fork(yourBookingsSaga),
    fork(yourOfferedRidesSaga),
    fork(ldapEnabledSaga),
  ]);
}
