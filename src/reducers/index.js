...
import ldapSignupReducer from './ldapSignupReducer';
import ldapLoginReducer from './ldapLoginReducer';
import yourBookingsReducer from './yourBookingsReducer';
import yourOfferedRidesReducer from './yourOfferedRidesReducer';
import ldapEnabledReducer from './ldapEnabledReducer';
...
export default combineReducers({
  ...
  ldapSignupReducer: ldapSignupReducer,
  ldapLoginReducer: ldapLoginReducer,
  yourBookingsReducer: yourBookingsReducer,
  yourOfferedRidesReducer: yourOfferedRidesReducer,
  ldapEnabledReducer: ldapEnabledReducer,
});
